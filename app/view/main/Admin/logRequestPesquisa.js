...
Ext.define('ConLogin.view.main.Admin.logRequestPesquisa', {
    ...
    columns: [
        ...
        },{ text: 'Tipo Equipamento :',  dataIndex: 'ID_Tipo_Req', flex: 1.6,hidden:true,
            filter: {
                type: 'string'
            }
        ...
        }, { text: 'Data Pedido ', dataIndex: 'Data_Pedido', flex: 1 ,hidden:true,
            filter: {
                type: 'string'
            }
        }, { text: 'ID Pedido ', dataIndex: 'ID_Pedido', flex: 1 ,
            filter: {
                type: 'string'
            }
        }
