...
class Backup_Database {
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
       ...
       $today = date("d-m-y");
        ...
        $query = mysqli_query($this->conn, "call RegBackup ('$this->backupFile','$username')");
    ...
    public function backupTables($tables = '*') {
        try {
            ...
            if ($this->gzipBackupFile) {
                ...
                //$this->obfPrint(' => Backup file succesfully saved => ' . $this->backupDir.'/'.$this->backupFile, 1, 1);
